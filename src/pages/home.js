    ...
    <div className="home">
      ...
      <section className="popular">
        ...
        <div className="card-grid">
          ...
          <div className="card">
            ...
            <AnimatePresence>
              {activeCard === 1 && (
                ...
                >
                  <p>
                    Nikmati keindahan Bali dengan pantai eksotis dan budaya yang memukau.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
          ...
          {/* CARD 2 */}
          <div className="card">
            <img src="/foto/eropa.jpeg" alt="Eropa" />
            <h3>Eropa</h3>
            <p>Mulai dari Rp 850.000</p>
            ...
            <AnimatePresence>
              {activeCard === 2 && (
                ...
                >
                  <p>
                    Destinasi tropis favorit dengan resort mewah dan sunset terbaik.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
          ...
          <div className="card">
            ...
            <AnimatePresence>
              {activeCard === 3 && (
                ...
                >
                  <p>
                    Paket wisata lengkap dengan tour guide dan hotel premium.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
